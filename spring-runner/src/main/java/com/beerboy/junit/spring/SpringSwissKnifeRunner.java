package com.beerboy.junit.spring;
...
/**
 * {@code SpringSwissKnifeRunner} is a custom extension of JUnit's
 ...
 * @author Manuel Santos (Migration to JUnit Swiss-knife)
 * @see SpringRunner
 ...
 */
public class SpringSwissKnifeRunner extends SwissKnifeRunner {

    private static final Logger LOGGER = LoggerFactory.getLogger(SpringSwissKnifeRunner.class);
     ...
     */
    public SpringSwissKnifeRunner(Class<?> clazz) throws InitializationError {
        super(clazz);
    ...
    static {
        if (!ClassUtils.isPresent("org.junit.internal.Throwables", SpringSwissKnifeRunner.class.getClassLoader())) {
            throw new IllegalStateException("SpringSwissKnifeRunner requires JUnit 4.12 or higher.");
        }

        withRulesMethod = ReflectionUtils.findMethod(SpringSwissKnifeRunner.class, "withRules",
